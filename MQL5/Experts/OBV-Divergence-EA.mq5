...
// Standard features
input double                InpLots                = 0.1;              // Order volume
input ulong                 InpMagic               = 222222;           // Magic number
...
int    handleObv;
int    atrHandle;
double obv[]; // bufeer to hold the obv values
double atr[]; // bufeer to hold the atr values
...
// Include the trade class to make trading easier
#include <Trade/Trade.mqh>
CTrade Trade;
